...
export const sampleAnimalOrgs = [
  ...
  },
  {
    ...
    briefBio:
      "The way to a hedgehog's heart is through its stomach. Show some love for your prickly friends and put your culinary skills to the test.",
    opportunities: [
      {
        oppDescrip:
          'Cook up some delish delights for our endangered nocturnal garden vistiors',
...
export const sampleEnvironmentOrgs = [
  {
...
export const sampleLocalGroupsOrgs = [
  {
    orgName: 'Puppy Love',
    briefBio:
...
export const sampleEventsOrgs = [
  {
    orgName: 'On Stage Cupids',
    briefBio:
      'Community theatre group looking for hearthrobs for its latest production.',
    opportunities: [
      {
        oppDescrip:
